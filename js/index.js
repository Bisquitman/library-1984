...
var API_URI = 'https://calm-mesa-84298.herokuapp.com';
...
var getStars = function getStars(rating) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img src=\"./img/star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(rating, " \u0438\u0437 5\" class=\"card__rating-star\">"));
    } else if (i < rating) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            books.forEach(function (_ref2) {
              ...
              item.innerHTML = "\n      <a href=\"./#/book?id=".concat(id, "\">\n        <article class=\"card\">\n          <div class=\"card__wrapper\">\n            <img class=\"card__image\" src=\"").concat(API_URI, "/").concat(image, "\" alt=\"\u041E\u0431\u043B\u043E\u0436\u043A\u0430 \u043A\u043D\u0438\u0433\u0438 ").concat(title, "\">\n\n            <p class=\"card__label\">").concat(labels[label], "</p>\n          </div>\n\n          <div class=\"card__content\">\n            <h3 class=\"card__title\">").concat(title, "</h3>\n\n            <p class=\"card__author\">").concat(author, "</p>\n\n            <p class=\"card__description\">").concat(description.substring(0, 80), "...</p>\n\n            <div class=\"card__rating\">\n              ").concat(getStars(rating).join(''), "\n            </div>\n          </div>\n        </article>\n      </a>\n    ");
...
var renderBook_getStars = function getStars(rating) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img src=\"./img/star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(rating, " \u0438\u0437 5\" class=\"book__rating-star\">"));
    } else if (i < rating) {
...
var renderBook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(id) {
    var _yield$Promise$all, _yield$Promise$all2, book, labels, singleBook;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            singleBook = function singleBook(_ref2) {
              var author = _ref2.author,
                  description = _ref2.description,
                  image = _ref2.image,
                  label = _ref2.label,
                  rating = _ref2.rating,
                  title = _ref2.title;
              bookContainer.innerHTML = "\n        <div class=\"book__wrapper\">\n          <img class=\"book__image\" src=\"".concat(API_URI, "/").concat(image, "\" alt=\"\u041E\u0431\u043B\u043E\u0436\u043A\u0430 \u043A\u043D\u0438\u0433\u0438 ").concat(title, "\">\n\n          <button class=\"book__label book__label_img book__btn\">").concat(labels[label], "</button>\n        </div>\n\n        <div class=\"book__content\">\n          <h2 class=\"book__title\">").concat(title, "</h2>\n\n          <p class=\"book__author\">").concat(author, "</p>\n\n          <div class=\"book__rating\">\n            ").concat(renderBook_getStars(rating).join(''), "\n          </div>\n\n          <p class=\"book__subtitle\">\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435</p>\n\n          <p class=\"book__description\">").concat(description.substring(0, 500), "...</p>\n        </div>\n      ");
            };
...
var backBtn = document.querySelector('.book__btn-back');

var closeAllPages = function closeAllPages() {
...
var initRouter = function initRouter() {
  ...
  router.on((_router$on = {}, _defineProperty(_router$on, location.pathname, function () {
    ...
    renderListBooks();
  }), _defineProperty(_router$on, 'book', function book(_ref) {
    ...
    renderBook(id);
  }), _defineProperty(_router$on, 'add', function add() {
    closeAllPages();
...
var searchBtns = document.querySelectorAll('.header__btn-search');
...
var btnBack = document.querySelector('.add__btn-back');
var count = 0;

var sendBook = function sendBook() {
